...
export class PsConfigOutdatedError extends ProgramError {
  override readonly name: string = 'ConfigOutdated';

  readonly code: number = 0x1770; // 6000
  
  constructor(program: Program, cause?: Error) {
    super('Config Outdated', program, cause);
  }
}
codeToErrorMap.set(0x1770, PsConfigOutdatedError);
nameToErrorMap.set('ConfigOutdated', PsConfigOutdatedError);
...
codeToErrorMap.set(0x1771, PsInvalidGlobalAuthorityError);
...
codeToErrorMap.set(0x1772, PsInvalidWithdrawAuthorityError);
...
codeToErrorMap.set(0x1773, PsInvalidArgumentError);
...
codeToErrorMap.set(0x1774, PsAlreadyInitializedError);
...
codeToErrorMap.set(0x1775, PsNotInitializedError);
...
codeToErrorMap.set(0x1776, PsProgramNotRunningError);
...
codeToErrorMap.set(0x1777, PsBondingCurveCompleteError);
...
codeToErrorMap.set(0x1778, PsBondingCurveNotCompleteError);
...
codeToErrorMap.set(0x1779, PsInsufficientUserTokensError);
...
codeToErrorMap.set(0x1781, PsInvalidStartTimeError);
...
codeToErrorMap.set(0x1782, PsWlInitializeFailedError);
...
codeToErrorMap.set(0x1783, PsWlNotInitializeFailedError);
...
codeToErrorMap.set(0x1784, PsAddFailedError);
...
codeToErrorMap.set(0x1785, PsRemoveFailedError);
...
codeToErrorMap.set(0x1786, PsWlNotInitializedError);
...
codeToErrorMap.set(0x1787, PsNotWhiteListError);
...
codeToErrorMap.set(0x1788, PsNotCompletedError);
...
codeToErrorMap.set(0x1789, PsNotBondingCurveMintError);
...
codeToErrorMap.set(0x178a, PsNotSOLError);
...
codeToErrorMap.set(0x178b, PsInvalidConfigError);
...
codeToErrorMap.set(0x178c, PsArithmeticErrorError);
...
codeToErrorMap.set(0x178d, PsInvalidFeeReceiverError);
...
codeToErrorMap.set(0x178e, PsInvalidMigrationAuthorityError);
nameToErrorMap.set('InvalidMigrationAuthority', PsInvalidMigrationAuthorityError);

/** InvalidAuthority: Invalid Authority */
export class PsInvalidAuthorityError extends ProgramError {
...
codeToErrorMap.set(0x178f, PsInvalidAuthorityError);
nameToErrorMap.set('InvalidAuthority', PsInvalidAuthorityError);

/** InvalidMeteoraProgram: Invalid Meteora Program */
export class PsInvalidMeteoraProgramError extends ProgramError {
  override readonly name: string = 'InvalidMeteoraProgram';

  readonly code: number = 0x1790; // 6032
  
  constructor(program: Program, cause?: Error) {
    super('Invalid Meteora Program', program, cause);
  }
}
codeToErrorMap.set(0x1790, PsInvalidMeteoraProgramError);
nameToErrorMap.set('InvalidMeteoraProgram', PsInvalidMeteoraProgramError);

/** InvalidDevBuy: Invalid Dev Buy */
export class PsInvalidDevBuyError extends ProgramError {
  override readonly name: string = 'InvalidDevBuy';

  readonly code: number = 0x1791; // 6033
  
  constructor(program: Program, cause?: Error) {
    super('Invalid Dev Buy', program, cause);
  }
}
codeToErrorMap.set(0x1791, PsInvalidDevBuyError);
nameToErrorMap.set('InvalidDevBuy', PsInvalidDevBuyError);

/** InvalidParameter: Invalid Parameter */
export class PsInvalidParameterError extends ProgramError {
  override readonly name: string = 'InvalidParameter';

  readonly code: number = 0x1792; // 6034
  
  constructor(program: Program, cause?: Error) {
    super('Invalid Parameter', program, cause);
  }
}
codeToErrorMap.set(0x1792, PsInvalidParameterError);
nameToErrorMap.set('InvalidParameter', PsInvalidParameterError);
