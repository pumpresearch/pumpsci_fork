...
import { Serializer, array, mapSerializer, option, string, struct, u64, u8 } from '@metaplex-foundation/umi/serializers';
...
export type CreateBondingCurveInstructionAccounts = {
  ...
  // Data.
  export type CreateBondingCurveInstructionData = { discriminator: Array<number>; name: string; symbol: string; uri: string; startSlot: Option<bigint>;  };

export type CreateBondingCurveInstructionDataArgs = { name: string; symbol: string; uri: string; startSlot: OptionOrNullable<number | bigint>;  };
...
export function createBondingCurve(
  ...
  const resolvedAccounts = {
          ...
          bondingCurveSolEscrow: { index: 4, isWritable: false as boolean, value: input.bondingCurveSolEscrow ?? null },
          global: { index: 5, isWritable: false as boolean, value: input.global ?? null },
          whitelist: { index: 6, isWritable: false as boolean, value: input.whitelist ?? null },
