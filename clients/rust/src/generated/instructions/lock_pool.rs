...
///   2. `[writable]` bonding_curve_sol_escrow
///   3. `[writable]` pool
///   4. `[writable]` lp_mint
///   5. `[writable]` a_vault_lp
///   6. `[writable]` b_vault_lp
///   7. `[]` token_b_mint
///   8. `[writable]` a_vault
///   9. `[writable]` b_vault
///   10. `[writable]` a_vault_lp_mint
///   11. `[writable]` b_vault_lp_mint
///   12. `[writable]` payer_pool_lp
///   13. `[writable, signer]` payer
///   14. `[writable]` fee_receiver
...
///   18. `[writable]` lock_escrow
///   19. `[writable]` escrow_vault
///   20. `[writable]` meteora_program
///   21. `[]` event_authority
#[derive(Default)]
