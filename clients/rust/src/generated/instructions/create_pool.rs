...
pub struct CreatePool {
    ...
    pub fee_receiver_token_account: solana_program::pubkey::Pubkey,

    pub bonding_curve_sol_escrow: solana_program::pubkey::Pubkey,
...
impl CreatePool {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(
            self.fee_receiver_token_account,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new(
            self.bonding_curve_sol_escrow,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new(
            self.payer_token_a,
...
///   16. `[writable]` bonding_curve_token_account
///   17. `[writable]` fee_receiver_token_account
///   18. `[writable]` bonding_curve_sol_escrow
...
///   24. `[writable, signer]` payer
///   25. `[writable]` mint_metadata
///   26. `[optional]` rent (default to `SysvarRent111111111111111111111111111111111`)
///   27. `[]` metadata_program
///   28. `[]` vault_program
///   29. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   30. `[]` associated_token_program
///   31. `[optional]` system_program (default to `11111111111111111111111111111111`)
///   32. `[writable]` meteora_program
#[derive(Default)]
pub struct CreatePoolBuilder {
    ...
    fee_receiver_token_account: Option<solana_program::pubkey::Pubkey>,
    bonding_curve_sol_escrow: Option<solana_program::pubkey::Pubkey>,
...
impl CreatePoolBuilder {
    ...
    #[inline(always)]
    pub fn fee_receiver_token_account(
        &mut self,
        fee_receiver_token_account: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
        self.fee_receiver_token_account = Some(fee_receiver_token_account);
        self
    }
    #[inline(always)]
    pub fn bonding_curve_sol_escrow(
        &mut self,
        bonding_curve_sol_escrow: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
        self.bonding_curve_sol_escrow = Some(bonding_curve_sol_escrow);
        self
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CreatePool {
            ...
            fee_receiver_token_account: self
                .fee_receiver_token_account
                .expect("fee_receiver_token_account is not set"),
            bonding_curve_sol_escrow: self
                .bonding_curve_sol_escrow
                .expect("bonding_curve_sol_escrow is not set"),
...
pub struct CreatePoolCpiAccounts<'a, 'b> {
    ...
    pub fee_receiver_token_account: &'b solana_program::account_info::AccountInfo<'a>,

    pub bonding_curve_sol_escrow: &'b solana_program::account_info::AccountInfo<'a>,
...
impl<'a, 'b> CreatePoolCpi<'a, 'b> {
    pub fn new(
        ...
        Self {
            ...
            fee_receiver_token_account: accounts.fee_receiver_token_account,
            bonding_curve_sol_escrow: accounts.bonding_curve_sol_escrow,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(
            *self.fee_receiver_token_account.key,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new(
            *self.bonding_curve_sol_escrow.key,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new(
        ...
        let mut account_infos = Vec::with_capacity(33 + 1 + remaining_accounts.len());
        ...
        account_infos.push(self.fee_receiver_token_account.clone());
        account_infos.push(self.bonding_curve_sol_escrow.clone());
...
impl<'a, 'b> CreatePoolCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreatePoolCpiBuilderInstruction {
            ...
            fee_receiver_token_account: None,
            bonding_curve_sol_escrow: None,
            payer_token_a: None,
            payer_token_b: None,
            payer_pool_lp: None,
    ...
    pub fn fee_receiver_token_account(
        &mut self,
        fee_receiver_token_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.fee_receiver_token_account = Some(fee_receiver_token_account);
        self
    }
    #[inline(always)]
    pub fn bonding_curve_sol_escrow(
        &mut self,
        bonding_curve_sol_escrow: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.bonding_curve_sol_escrow = Some(bonding_curve_sol_escrow);
        self
    }
    #[inline(always)]
...
struct CreatePoolCpiBuilderInstruction<'a, 'b> {
    ...
    fee_receiver_token_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    bonding_curve_sol_escrow: Option<&'b solana_program::account_info::AccountInfo<'a>>,
